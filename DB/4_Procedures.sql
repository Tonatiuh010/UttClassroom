...
CREATE PROCEDURE GET_STUDENTS(
    ...
    SELECT 
        ...
        S.NAME, S.LAST_NAME,
		S.IMAGE, S.BIRTH, S.BIRTH_LOCATION,
        BIRTH_L.COUNTRY_ID, BIRTH_L.CITY_ID,
		BIRTH_L.CITY, C.CONTACT_ID,
        C.EMAIL1, C.EMAIL2, C.PHONE1, C.PHONE2,
		SA.ADDRESS_ID, SA.STREET, SA.NUMBER,
		SA.NEIGHBORHOOD, SA.LOCATION_ID ADDRESS_LOCATION,
        GENRE.ASSET_ID GENRE_ID, GENRE.ASSET_CODE GENRE_CODE, 
		GENRE.NAME GENRE, MARITAL.ASSET_ID MARITAL_ID,
		MARITAL.ASSET_CODE MARITAL_CODE,
		MARITAL.NAME MARITAL,
		S.LABOR_ID, LS.DEPARTMENT, LS.BUSINESS,
		LS.ADDRESS_ID LABOR_ADDRESS, LS.CONTACT_ID LABOR_CONTACT,
		LS.IS_STUDY, SS.SCHOLARLY_ID, SS.SCHOOL_NAME,
        SS.SCH_TYPE_ID, SS.ADDRESS_ID SCHOLARLY_ADDRESS
	FROM 
		STUDENT S JOIN  ASSET GENRE ON GENRE.ASSET_ID = S.GENRE_ID
                  ...
                  LEFT JOIN SCHOLARLY SS ON SS.SCHOLARLY_ID = S.SCHOLARLY_ID
	WHERE
